export default class ChooseLevelScene extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.image('invader7', 'src/assets/sprites/OrangeAlien.png')
        */
    }
    ...
    create(){
        ...
        this.addButton(-500, -100, 'Level 7', this.level7Button, 'Level7')
        this.addButton(0, -100, 'Level 8', this.level8Button, 'Level8')

        this.add.image(window.innerWidth/2 - 500, window.innerHeight/2 - 275, 'invader').setScale(0.4)
        this.add.image(window.innerWidth/2, window.innerHeight/2 - 275, 'invader2').setScale(0.066)
        this.add.image(window.innerWidth/2 + 500, window.innerHeight/2 - 275, 'invaderLevel3').setScale(0.4)
        ...
        this.add.image(window.innerWidth/2 + 500, window.innerHeight/2 - 25, 'invader6').setScale(0.4)
        this.add.image(window.innerWidth/2 - 500, window.innerHeight/2 + 250, 'invader7').setScale(0.4)
        this.add.image(window.innerWidth/2, window.innerHeight/2 + 250, 'bossInvader').setScale(0.4)
