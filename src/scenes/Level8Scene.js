...
export default class Level8Scene extends Phaser.Scene {
  ...
  create() {
    ...
    this.bossLaser=this.matter.add.sprite(-500,-500,"bossLaser").setScale(0.5,2).setOrigin(0.5,0.5).setSensor(true).setName("bossLaser")
...
*/
    ...
    this.matter.world.on('collisionstart', (event)=>{
      event.pairs.forEach(pair => {
        ...
        let playBossLaserCollision= (gameObjectA instanceof Player && gameObjectB.name=='bossLaser') || (gameObjectA.name=='bossLaser' && gameObjectB instanceof Player)
  ...
  playSecondTween(){
    ...
    this.tweens.add({
        ...
        onComplete: ()=>{
            ...
            this.bossLaser.setPosition(-1000,-1000)
            this.playFirstTween()
        },
        //completeDelay: 3000
    });
